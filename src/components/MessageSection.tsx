    ...
    <section className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6 text-black">
            A Golden Anniversary
          </h2>

          <p className="text-lg md:text-xl text-gray-900 leading-relaxed mb-6 font-serif italic">
          ...
          <p className="text-lg md:text-xl text-gray-900 leading-relaxed mb-8">
          ...
          <p className="text-lg md:text-xl font-medium text-black">Your Family</p>
        </motion.div>
      </div>
    </section>
  );
